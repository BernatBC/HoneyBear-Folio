    ...
    <div className="modal-overlay" style={{ zIndex: 9999 }}>
      <div className="modal-container" style={{ maxWidth: "500px", width: "90%" }}>
        <div className="modal-header">
          <h2 className="modal-title text-xl font-bold">{t("Welcome to HoneyBear Folio")}</h2>
        </div>
        <div className="modal-body p-6">
            ...
            {/* Locale Selection */}
             <div className="mb-6">
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">{t("Number Format")}</label>
                 <CustomSelect
                    value={locale}
                    onChange={setLocale}
                    options={[
